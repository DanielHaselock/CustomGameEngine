...
ShadowTexture::ShadowTexture(Rendering::Renderer::VK::VKRenderer& pRenderer)
{
    ...
    VkDescriptorImageInfo mImageInfo{ mTextureSampler, pRenderer.mShadowPass.mDepthImageView, VK_IMAGE_LAYOUT_DEPTH_STENCIL_READ_ONLY_OPTIMAL };
